...
public class BDWolf {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition wolf_tail = real_tail.addOrReplaceChild("wolf_tail", CubeListBuilder.create(), PartPose.offset(-1.0F, -1.6793F, 0.7969F));
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 13.2F, 2.2F, 1.5708F, 0.0F, 0.0F));

		PartDefinition body_rotation = body.addOrReplaceChild("body_rotation", CubeListBuilder.create(), PartPose.offset(0.0F, -0.2F, -0.8F));
		...
		PartDefinition upper_body = partdefinition.addOrReplaceChild("upper_body", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 13.1F, -3.75F, 1.5708F, 0.0F, 0.0F));

		PartDefinition mane_rotation = upper_body.addOrReplaceChild("mane_rotation", CubeListBuilder.create(), PartPose.offset(0.0F, 3.25F, -3.4F));
		...
		PartDefinition glowing_eyes = partdefinition.addOrReplaceChild("glowing_eyes", CubeListBuilder.create(), PartPose.offset(0.0F, 11.4F, -8.0F));

		PartDefinition real_glowing_eyes = glowing_eyes.addOrReplaceChild("real_glowing_eyes", CubeListBuilder.create().texOffs(853, 3).addBox(1.4261F, -0.6912F, -2.01F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(853, 3).mirror().addBox(-2.4246F, -0.6912F, -2.01F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, -1.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, 11.4F, -8.0F));

		PartDefinition real_head = head.addOrReplaceChild("real_head", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition right_ear = real_head.addOrReplaceChild("right_ear", CubeListBuilder.create(), PartPose.offset(-2.5F, -2.9F, 1.5F));
		...
		PartDefinition left_ear = real_head.addOrReplaceChild("left_ear", CubeListBuilder.create(), PartPose.offset(2.5F, -2.9F, 1.5F));
		...
		PartDefinition wolfhead = real_head.addOrReplaceChild("wolfhead", CubeListBuilder.create(), PartPose.offset(-1.0F, 0.1F, 4.0F));
		...
		PartDefinition head_sub_109 = oog5.addOrReplaceChild("head_sub_109", CubeListBuilder.create().texOffs(830, 2).mirror().addBox(1.2504F, -0.3684F, -0.167F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.01F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition oog6 = Nieuwwolf.addOrReplaceChild("oog6", CubeListBuilder.create().texOffs(830, 2).addBox(-2.2489F, -0.3683F, -0.0669F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(2.0163F, -0.6228F, -3.683F, 0.0019F, -0.0436F, -0.0271F));
